...
which talks to bitcoind using the JSON-RPC interface. The code, found [here](https://github.com/kimitzu-foundation/kimitzu-go/tree/master/bitcoin/bitcoind), could be
...
fluctuations. This functionality is provided by the a package implementing the [ExchangeRates](https://github.com/kimitzu-foundation/kimitzu-go/blob/master/bitcoin/exchangerates.go) interface.
...
The wallet selection switch can be found [in openbazaard.go](https://github.com/kimitzu-foundation/kimitzu-go/blob/master/openbazaard.go):
```go
