...
which talks to bitcoind using the JSON-RPC interface. The code, found [here](https://github.com/djali-foundation/djali-go/tree/master/bitcoin/bitcoind), could be
...
fluctuations. This functionality is provided by the a package implementing the [ExchangeRates](https://github.com/djali-foundation/djali-go/blob/master/bitcoin/exchangerates.go) interface.
...
The wallet selection switch can be found [in openbazaard.go](https://github.com/djali-foundation/djali-go/blob/master/openbazaard.go):
```go
